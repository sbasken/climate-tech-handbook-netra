...
<Callout type="info"> We will show you how to: </Callout>
<Steps>
### Choose your [employer type](#choose-your-employer-type) and look at [job boards](#job-boards)
### Evaluate your [skills and experience](#evaluate-your-skills-and-experience)
### Build your [community and network](build-your-community-and-network)
### Pick your [climate solution](solutions) and [information diet](resources)
</Steps>


## First: Choose your employer type

<Callout type="info"> You have a choice </Callout> 
...
<Callout type="info"> Tech skills and experience </Callout>
...
<div style={{display: 'flex', flexWrap: 'wrap'}}>
    ...
    imageUrl="../../static/img/aigen-robotics.png"
    linkUrl="/solutions"
    />
...
<Cards num={3}>
  <Cards.Card
    ...
    href="../solutions"
  >
    <>![Documentation theme](../../static/img/aigen-robotics.png)</>
  </Cards.Card>
  <Cards.Card image arrow title="Information Diet" href="/resources">
    <>![Blog theme](../../static/img/healthy-lifestyle.jpg)</>
  </Cards.Card>
</Cards>
