...
<Callout type="info"> What is Project Drawdown? </Callout>
...
<div style={{ display: 'flex', flexWrap: 'wrap'}}>
  ...
  <ImageCard 
        ...
        imageUrl="../static/img/electricity.png"
    ...
    <ImageCard 
        ...
        imageUrl="../static/img/food-agriculture-and-land-use.jpg"
...
{/* <Cards num={3}>
  <Cards.Card
    ...
    arrow
    title="Electricity"
    href="../solutions-electricity"
  >
    <>![Documentation theme](../../static/img/electricity.png)</>
    <div style={{ padding: '10px' }}>
    In order to electrify everything with zero emissions, we need to upgrade our entire infrastructure
    </div>
  </Cards.Card>
  <Cards.Card 
    image 
    arrow 
    title="Food, Agriculture, and Land Use" 
    href="/docs/sector-food-agriculture-and-land-use">
    <>![Blog theme](../../static/img/food-agriculture-and-land-use.jpg)</>
  </Cards.Card>
  <Cards.Card
    image
    arrow
...
<ImageCard 
    ...
    imageUrl="../static/img/land-sinks.jpg"
...
<ImageCard 
    ...
    imageUrl="../static/img/coastal-and-ocean-sinks.png"
...
<ImageCard 
    ...
    imageUrl="../static/img/biochar-production.jpg"
...
<ImageCard 
    ...
    imageUrl="../static/img/healthy-lifestyle.jpg"
...
<ImageCard 
    ...
    imageUrl="../static/img/adaptation.jpg"
...
<ImageCard 
    ...
    imageUrl="../static/img/journalism.jpg"
...
<ImageCard 
    ...
    imageUrl="../static/img/advocacy-and-policy.jpg"
